...
/* cordinate system transformation -> polar to rectangle */
...
// fields for displaying characters vibration
var vibrateCV = new closeValue(200, 500);
var invertCV = new closeValue(1000, 1200);
var timer = null;

/* a function that resume the typeface */
var resume = function() {
...
document.body.onmousemove = function(e) {
	camera.rotate.x = e.pageY / window.innerHeight * 40 - 20;
	camera.rotate.y = e.pageX / window.innerWidth * 40 - 20;
