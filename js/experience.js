function initHistoryHandler() {
    ...
    var hoverOrClick = function() {
        ...
        $("#historic-event-2, #historic-event-3, #historic-event-4, #historic-event-5, #historic-event-6, #historic-event-7").removeClass("current");
    }
    ...
    hoverOrClick = function() {
        ...
        clock.removeClass("animate2 animate3 animate4 animate5 animate6");
        $(this).addClass("current");
        ...
        $("#historic-event-1, #historic-event-3, #historic-event-4, #historic-event-5, #historic-event-6, #historic-event-7").removeClass("current");
    }
    ...
    hoverOrClick = function() {
        ...
        clock.removeClass("animate1 animate3 animate4 animate5 animate6");
        $(this).addClass("current");
        ...
        $("#historic-event-1, #historic-event-2, #historic-event-4, #historic-event-5, #historic-event-6, #historic-event-7").removeClass("current");
    }
    ...
    hoverOrClick = function() {
        ...
        clock.removeClass("animate1 animate2 animate4 animate5 animate6");
        $(this).addClass("current");
        ...
        $("#historic-event-1, #historic-event-2, #historic-event-3, #historic-event-5, #historic-event-6, #historic-event-7").removeClass("current");
    }
    ...
    hoverOrClick = function() {
        ...
        clock.removeClass("animate1 animate2 animate3 animate5 animate6");
        $(this).addClass("current");
        ...
        $("#historic-event-1, #historic-event-2, #historic-event-3, #historic-event-4, #historic-event-6, #historic-event-7").removeClass("current");
    }
    ...
    hoverOrClick = function() {
        ...
        clock.removeClass("animate1 animate2 animate3 animate4 animate6");
        $(this).addClass("current");
        ...
        $("#historic-event-1, #historic-event-2, #historic-event-3, #historic-event-4, #historic-event-5, #historic-dot-7").removeClass("current");
    }
    ...
    hoverOrClick = function() {
        ...
        for (var i = 0; i < yearList.length - 1; i++)
          yearList.eq(i).css("font-size", "16px");
        $("#historic-event-1, #historic-event-2, #historic-event-3, #historic-event-4, #historic-event-5, #historic-event-6").removeClass("current");
    }
